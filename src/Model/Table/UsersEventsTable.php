 ...
 * @method \App\Model\Entity\UsersEvent|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\UsersEvent|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
