...
class PublicationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type_of_publication_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'idTypeOfPublication' => ['type' => 'index', 'columns' => ['type_of_publication_id'], 'length' => []],
        ...
        '_constraints' => [
            ...
            'publications_ibfk_2' => ['type' => 'foreign', 'columns' => ['photo_id'], 'references' => ['photos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'publications_ibfk_3' => ['type' => 'foreign', 'columns' => ['type_of_publication_id'], 'references' => ['type_of_publications', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'publications_ibfk_4' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
